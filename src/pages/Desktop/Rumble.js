  ...
  return (
    ...
    >
      ...
      <div className="cutscene-container" style={{ position: "relative", height: "101vh", overflow: "hidden", borderBottom: "5px solid lime", }}>
        ...
        <div style={{ position: "relative", zIndex: 1, height: "100%" }}>
          ...
          <div className="video-title left">
            <div className="type-up" style={{ display: "flex", gap: 6 }}>
          ...
          <div className="video-title right">
            <div className="type-down" style={{ display: "flex", gap: 6 }}>
      ...
      <div className="how-it-works">
        <div style={{ fontFamily: "Montserrat, sans-serif", marginTop: 60, marginBottom: 40, textAlign: "center" }}>
          <h2 style={{ paddingLeft: "20px", textAlign: "left", color: "white", fontSize: 52, fontWeight: "bold" }}>HOW IT WORKS</h2>
        </div>
        ...
        <div style={{ fontFamily: "Montserrat, sans-serif", padding: "0 20px" }}>
          ...
          >
            ...
            >
              ...
              <div style={{ color: "white", fontFamily: "Montserrat, sans-serif", fontWeight: 800, fontSize: 20, paddingBottom: '70px' }}>COLLEGE</div>
              <p style={{ color: "white", fontSize:22}}> Campuses clash for the title. Represent yours with pride.</p>
            ...
            >
              ...
              <p style={{ color: "white", fontSize:22 }}>Open for schools. It's your turn to show your talent and get noticed.</p>
            </div>
            ...
            >
              ...
              <p style={{ color: "white", fontSize:22 }}> For anybody and everybody. Get in. Compete. Stand Out.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        >
          ...
          >
            <div style={{ width: 80, height: 'auto', display: "flex", alignItems: "center", justifyContent: "center" }}>
              <img src="./rocketleague-roc.webp" alt="Rocket League" style={{ width: "200px", height: 'auto', borderRadius:'20px', border:'3px solid lime' }} />
            </div>
            </div>
          ...
          >
            <div style={{ width: 80, height: 'auto', display: "flex", alignItems: "center", justifyContent: "center" }}>
              <img src="./rivals-roc.webp" alt="Marvel Rivals" style={{ width: "200px", height: 'auto', borderRadius:'20px', border:'3px solid lime'}} />
            </div>
      ...
      <div style={{ fontFamily: "Montserrat, sans-serif", padding: "0 20px" }}>
          ...
          >
            ...
            <iframe style={{alignContent:"center"}} src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1339.9520972716987!2d-67.142830946453!3d18.21190621976029!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8c02b232ee6247a1%3A0x78a291cf8d44a7a4!2sColiseo%20Rafael%20A.%20Mangual!5e0!3m2!1sen!2spr!4v1764738272509!5m2!1sen!2spr" width="600" height="520" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
