...
const players = [
    { user: "MYNTACH", title: "Captain" },
    { user: "FLXZ", title: "Player" },
    { user: "CARLILLOS90", title: "Player" },
...
<div id="svg" style={{zIndex:0 }}>
<svg  fill="none" xmlns="http://www.w3.org/2000/svg" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', zIndex: 0, pointerEvents: 'none' }}>
